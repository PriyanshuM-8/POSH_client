  ...
  return (
    <div className="space-y-6">
      <motion.div
        ...
        className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-900 via-[#1e3a8a] to-[#2563EB] p-6 text-white shadow-lg"
      >
        <div className="absolute inset-0 opacity-10 [background-image:radial-gradient(circle_at_1px_1px,white_1px,transparent_0)] [background-size:24px_24px]" />
        <div className="relative flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            <p className="text-xs font-semibold uppercase tracking-wider text-blue-200">INTERNAL COMMITTEE PORTAL</p>
            <h1 className="mt-1 text-2xl font-bold">Hello, {currentUser?.fullName}</h1>
            <p className="mt-1 text-sm text-blue-200">Overseeing {openCases.length} active statutory investigations.</p>
          </div>
          <Badge variant="success" dot className="bg-white/15 ring-white/10 text-white shrink-0">
            IC STATUS: ACTIVE
          </Badge>
        </div>
      </motion.div>
          ...
          <>
            <Card>
              <CardContent className="p-5 flex items-center justify-between">
                <div>
                  <p className="text-xs text-slate-500 font-semibold uppercase">Assigned Cases</p>
            ...
            <Card>
              <CardContent className="p-5 flex items-center justify-between">
                <div>
                  <p className="text-xs text-slate-500 font-semibold uppercase">Scheduled Hearings</p>
            ...
            <Card>
              <CardContent className="p-5 flex items-center justify-between">
                <div>
                  <p className="text-xs text-slate-500 font-semibold uppercase">Completed Hearings</p>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <CardHeader>
            <CardTitle>Cases Workspace</CardTitle>
            <CardDescription>Active statutory investigations assigned to your committee</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Upcoming case sessions</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3 pt-0">
