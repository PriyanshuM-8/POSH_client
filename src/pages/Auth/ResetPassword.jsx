    ...
    <div className="flex min-h-screen w-full bg-[#F8FAFC]">
      ...
      <div className="flex w-full flex-col justify-center px-6 py-12 sm:px-10 lg:w-1/2 lg:px-20">
        ...
        >
          ...
          <p className="mt-1.5 text-sm text-slate-500">Please choose a secure new password for your account.</p>

          {success ? (
            <div className="mt-8 space-y-6">
              <div className="rounded-lg bg-green-50 border border-green-200 p-4">
                <p className="text-sm font-medium text-green-800">Password Changed</p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-4">
              {!token && (
                <div className="rounded-lg bg-yellow-50 border border-yellow-200 p-3 text-xs text-yellow-800">
                  Warning: No reset token found in URL. Make sure you copied the full link.
                </div>
              )}
